    ...
    <div className={styles.proyectCard}>
      ...
      <div className={styles.imgCont}>
        ...
        <div className={styles.buttonLinks}>
          <Link className="w-100" target={"_blank"} to={githubRepo}>
            <button className="btn btn-outline-dark btn-floating w-100">
              <i className="fa-brands fa-github"></i>
            </button>
          </Link>
          <Link className="w-100" target={"_blank"} to={externalLink}>
            <button className="btn btn-outline-dark btn-floating  w-100 ">

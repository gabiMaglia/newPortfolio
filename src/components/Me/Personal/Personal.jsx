...
const Personal = () => {
  ...
  const persona = {
    ...
    about:
      'Self-motivated <strong style="font-size: 19px; font-weight:2 00"> developer </strong> who is willing to learn and create outstanding UI applications.',
  };
  return (
      ...
      <section id="personal-data" className=" g-0">
        ...
        <article className="data-div col-lg">
          <div className="about ">
            ...
            <p dangerouslySetInnerHTML={{ __html: persona.about }}></p>
          </div>
